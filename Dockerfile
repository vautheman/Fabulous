...
HEALTHCHECK --interval=30s --timeout=10s --start-period=120s --retries=3 CMD wget --header="Authorization: ${LAVALINK_PASSWORD}" -qO- http://localhost:2333/version > /dev/null || exit 1
