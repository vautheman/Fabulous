...
HEALTHCHECK --interval=30s --timeout=10s --start-period=60s --retries=3 CMD curl -sf -H "Authorization: ${LAVALINK_PASSWORD}" http://localhost:2333/version >/dev/null || exit 1
